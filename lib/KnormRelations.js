  ...
  updateQuery(knorm) {
    ...
    class RelationsQuery extends Query {
      ...
      leftJoin(queries, options) {
        return this.addJoin(
          queries,
          Object.assign({}, options, { joinType: 'leftJoin' })
        );
      }
      ...
      innerJoin(queries, options) {
        return this.addJoin(
          queries,
          Object.assign({}, options, { joinType: 'innerJoin' })
        );
      }
      ...
      join(queries, options) {
        return this.addJoin(
          queries,
          Object.assign({}, options, { joinType: 'join' })
        );
      }
      ...
      async prepareJoin(sql, options) {
        const method = this.getOption('joinType');
        const table = this.getTable();
        const on = this.getOn(this.parent, this);
